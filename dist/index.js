...
var TestingChart = /*#__PURE__*/function (_ChartComponent) {
  ...
  _createClass(TestingChart, [{
    ...
    value: function draw() {
      ...
      g.appendSelect('line.base-line').attr('x1', 0).attr('x2', width - props.margin.left - props.margin.right).attr('y1', yScale(0) + 0.5).attr('y2', yScale(0) + 0.5);
      ...
      if (data.tests[0].posRate >= 2) {
        labelG.attr('transform', "translate(".concat(width - props.margin.left - props.margin.right - 20, ",").concat((props.height - props.margin.top - props.margin.bottom) * 0.93, ")")).style('text-anchor', 'end');
      } else {
        labelG.attr('transform', "translate(".concat(width - props.margin.left - props.margin.right - 20, ",").concat((props.height - props.margin.top - props.margin.bottom) * 0.5, ")")).style('text-anchor', 'end');
      }
